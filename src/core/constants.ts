...
export const NO_LYRICS_TEXT_SELECTOR: string = "#tab-renderer > ytmusic-message-renderer > yt-formatted-string.text.style-scope.ytmusic-message-renderer";
...
export const INITIALIZE_LOG: string = "%c[BetterLyrics] Loaded Successfully. Logs are enabled by default. You can disable them in the extension options.";
...
// UI State Logs
export const LYRICS_TAB_HIDDEN_LOG: string = "[BetterLyrics] (Safe to ignore) Lyrics tab is hidden, skipping lyrics fetch";
...
export const LYRICS_WRAPPER_NOT_VISIBLE_LOG: string = "[BetterLyrics] (Safe to ignore) Lyrics wrapper is not visible, unable to inject lyrics";
export const LYRICS_WRAPPER_CREATED_LOG: string = "[BetterLyrics] Lyrics wrapper created";
export const FOOTER_NOT_VISIBLE_LOG: string = "[BetterLyrics] (Safe to ignore) Footer is not visible, unable to inject source link";
export const LYRICS_TAB_NOT_DISABLED_LOG: string = "[BetterLyrics] (Safe to ignore) Lyrics tab is not disabled, unable to enable it";
...
export const ALBUM_ART_ADDED_FROM_MUTATION_LOG: string = "[BetterLyrics] Album art added to the layout from mutation event";
...
export const SYNC_DISABLED_LOG: string = "[BetterLyrics] Syncing lyrics disabled due to all lyrics having a start time of 0";
export const YT_MUSIC_LYRICS_AVAILABLE_LOG: string = "[BetterLyrics] Lyrics are available on the page & backend failed to fetch lyrics";
...
export const NO_LYRICS_ELEMENT_LOG: string = "[BetterLyrics] No lyrics element found on the page, skipping lyrics injection";
